...
* Description: The world's first Content Delivery Network (CDN) that pays you to use it. To get started: activate the Arc plugin, then go to the Arc Settings page to set up your Arc account.
* Version: 1.1.6
* Author: Arc
